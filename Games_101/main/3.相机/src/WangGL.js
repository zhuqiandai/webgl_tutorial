class WangGL {
  ...
  drawSimpleCube() {
    ...
    this.gl.uniform4fv(colorLoc, [1.0, 0.0, 0.0, 1.0])
    this.gl.drawElements(this.gl.TRIANGLES, indices.length, this.gl.UNSIGNED_SHORT, 0)

    this.gl.bindVertexArray(null)
  }

  applyModelMatrix(mat) {
    const modelLoc = this.gl.getUniformLocation(this.program, "u_modelMatrix")
  ...
  applyViewMatrix(mat) {
    ...
    this.gl.uniformMatrix4fv(viewLoc, false, mat)
  }
}
