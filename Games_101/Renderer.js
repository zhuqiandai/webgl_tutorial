class Renderer {
  ...
  modelMat(mat) {
    const location = this.gl.getUniformLocation(this.program, 'uModelMatrix')

    this.gl.uniformMatrix4fv(location, false, mat)
  }

  viewMat (mat) {
    const location = this.gl.getUniformLocation(this.program, 'uViewMatrix')

    this.gl.uniformMatrix4fv(location, false, mat)
  }

  projectMat(mat) {
    const location = this.gl.getUniformLocation(this.program, 'uProjectMatrix')
